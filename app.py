...
app = Flask(__name__)
app.secret_key = "my_secret_key" # Needed for flash msgs
# Database config
db_config = {
'host': 'database.cboag2uqw1lc.us-east-1.rds.amazonaws.com',
'user': 'admin',
'password': 'Surya123',
'database': 'bank'
}
cnxpool = mysql.connector.pooling.MySQLConnectionPool(pool_name="mypool", pool_reset_session=True, pool_size=5, **db_config)
